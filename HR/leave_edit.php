  ...
  <center><table width="500" border="1" style="width: 500px" class="table table-bordered">
    <tbody>    
      ...
      <tr>
        ...
        <td><input name="leave_from" type="date" class="form-control" id="leave_from" value="<?=$leave_from?>" READONLY></td>
      </tr>
      <tr>
        <td> &nbsp;ขอลาตั้งแต่วันที่</td>
        <td><input name="leave_to" type="date" class="form-control" id="leave_to" value="<?=$leave_to?>" READONLY></td>
      </tr>
      <tr>
        <td> &nbsp;ลายละเอียดการลา</td>
        <td><input name="leave_description" type="text" class="form-control" id="leave_description" value="<?=$leave_description?>" READONLY></td>
      </tr>
      <tr>
        <td>&nbsp;สถานะการลา</td>
