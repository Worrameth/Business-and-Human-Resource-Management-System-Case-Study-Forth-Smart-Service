...
<form action="borrow_headphones_save.php?id=<?php echo $hpId;?>" method="post" enctype="multipart/form-data">
  ...
  <tbody>    
      ...
      <tr>
        <td> &nbsp;รหัสหูฟัง</td>
        <td><input name="hpId" id="hpId" type="text" value="<?=$hpId?>" READONLY></td>
       </tr>
      <tr>
        <td> &nbsp;ยืมที่วันที่</td>
      ...
      <br>
          ...
          <a href="headphones.php" class="btn btn-secondary" role="button">ยกเลิก</a>
</form>
</div>
</body>
</html>