...
<form action="borrow_wireless_save.php?id=<?php echo $wrId;?>" method="post" enctype="multipart/form-data">
  <center><table width="500" border="1" style="width: 500px" class="table table-bordered">
  <tbody>    
      <tr>
        <br><a style="text-align: center;"><h2>หน้าแบบฟอร์มยืมไวร์เลส</h2><br></a>
      </tr>
      <tr>
        <td> &nbsp;รหัสไวร์เลส</td>
        <td><input name="wrId" id="wrId" type="text" value="<?=$wrId?>" READONLY></td>
       </tr>
      <tr>
        <td> &nbsp;ยืมที่วันที่</td>
      ...
      <br>
          ...
          <a href="wireless.php" class="btn btn-secondary" role="button">ยกเลิก</a>
</form>
</div>
</body>
</html>